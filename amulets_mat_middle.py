...
WHERE temp = 'middle napatan' AND b.site_id IN (1,2) AND a.material IS NOT NULL
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'images/amulets_mat_middle.png',scale=3, width=400, height=200)