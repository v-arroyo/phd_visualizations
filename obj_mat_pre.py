...
WHERE temp = 'pre-25th dyn.' AND b.site_id IN (1,2) AND a.artifact_material IS NOT NULL
GROUP BY 1,2,3
"""
...
fig = px.scatter(
    ...
    symbol="owner",
    facet_col='site_name',
    title="Pre-25th Dynasty object materials",
...
pio.write_image(fig, 'images/obj_mat_pre.png',scale=3, width=400, height=300)