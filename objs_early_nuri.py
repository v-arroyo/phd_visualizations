...
WHERE temp = 'early napatan' AND b.site_id IN (2) AND artifact_type NOT IN ('beads', 'shabtis')
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'images/objs_early_nuri.png',scale=3, width=500, height=400)