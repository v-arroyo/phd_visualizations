...
WHERE temp = 'middle napatan' AND b.site_id IN (2) AND artifact_type NOT IN ('shabtis', 'ceramic vessels')
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'images/objs_middle.png',scale=3, width=500, height=350)