...
WHERE temp = 'early napatan' AND b.site_id IN (1,2) AND a.artifact_material IS NOT NULL
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'phd_final/images/objects_mat_early_kurru.png',scale=3, width=450, height=450)