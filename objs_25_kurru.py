...
WHERE temp = '25th dyn.' AND b.site_id IN (1) AND artifact_type NOT IN ('beads', 'shabtis')
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'images/objs_25_kurru.png',scale=3, width=450, height=400)