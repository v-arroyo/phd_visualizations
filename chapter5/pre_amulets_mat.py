...
where dating = 'napatan' and b.site_id in (4,5,6,7,8,9,10) and material IS NOT NULL and temp = 'pre-25th'
    and super != 'pyramid' 
...
pio.write_image(fig, 'images/chapter5/pre_amulets_mat.png',scale=3, width=450, height=250)