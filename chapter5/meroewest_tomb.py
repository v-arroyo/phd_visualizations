...
WHERE dating = 'napatan' AND b.site_id = 4 AND sub != 'deposit'
GROUP BY 1,2,3
"""
...
fig = px.bar(
    ...
    facet_row="sub",
    text="total_burials",
    title="Meroe West tomb structures",
...
pio.write_image(fig, 'images/chapter5/meroewest_tomb.png',scale=3, width=450, height=400)