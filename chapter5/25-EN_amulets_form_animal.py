...
fig = px.bar(
    ...
    text="total",
    barmode='stack',
    title="25th Dynasty-Early Napatan non-elite animal amulet motifs",
...
pio.write_image(fig, 'images/chapter5/25-EN_amulets_form_animal.png',scale=3, width=550, height=400)