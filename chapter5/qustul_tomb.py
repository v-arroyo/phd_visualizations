...
WHERE dating = 'napatan' AND b.site_id = 9 AND sub != 'deposit'
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'images/chapter5/qustul_tomb.png',scale=3, width=450, height=400)