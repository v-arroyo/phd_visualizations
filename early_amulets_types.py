...
WHERE temp = 'early napatan' AND b.site_id IN (1,2)
GROUP BY 1,2,3
"""
...
fig = px.bar(
    ...
    text='count',
    barmode='stack',
    title="Early Napatan amulet types",
...
pio.write_image(fig, 'images/early_amulets_types.png',scale=3, width=450, height=200)