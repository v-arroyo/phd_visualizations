...
fig = px.scatter(
    ...
    color="total",
    text="total",
    title="Distribution of amulets with deity motifs by social group",
...
pio.write_image(fig, 'diversenile/images/amulets_deities.png',scale=4, width=550, height=550)